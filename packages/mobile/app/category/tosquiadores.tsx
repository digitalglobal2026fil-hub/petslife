  ...
  return (
    <TouchableOpacity onPress={onPress} activeOpacity={0.85} style={{
      ...
      <View style={{ flexDirection: "row", padding: 16, gap: 14 }}>
        <View style={{ width: 64, height: 64, borderRadius: 18, backgroundColor: "#FDF2F8", alignItems: "center", justifyContent: "center" }}>
          <Text style={{ fontSize: 30, backgroundColor: "transparent" }}>✂️</Text>
        </View>
        <View style={{ flex: 1 }}>
...
export default function TosquiadoresScreen() {
  ...
  const filtered = allBiz.filter((b: any) => b.type === "tosquiador" &&
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: "#FFF8FC" }}>
      ...
      {/* Search */}
      <View style={{ marginHorizontal: 20, marginBottom: 16, flexDirection: "row", alignItems: "center", backgroundColor: "#fff", borderRadius: 16, borderWidth: 1.5, borderColor: "#FCE7F3", paddingHorizontal: 14, height: 46 }}>
